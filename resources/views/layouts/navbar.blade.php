<div class="bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <div class="h-6 w-8 mr-2 fill-current">
            <img src="{{asset('images/logo.png')}}" class="img-circle elevation-2" alt="User Image" width="100" height="120" margin="absolut"
            >
          </div>
        <span class="font-semibold text-sm sm:text-xl tracking-tight">SMK TELEMATIKA</span>
    </div>
    <div class="relative">
        @auth
